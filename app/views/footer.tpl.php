        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php foreach ($array_productType as $productType) : ?>

                <li> <a href="<?= $this->baseUrl.'/catalogue/type/'.$productType->getId(); ?>" class="text-muted"><?= $productType->getName(); ?></a></li>
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php foreach ($array_brands as $brand) : ?>

                <li> <a href="<?= $this->baseUrl.'/catalogue/brand/'.$brand->getId(); ?>" class="text-muted"><?= $brand->getName(); ?></a></li>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
              <li class="list-inline-item">
                <img src="<?= $this->baseUrl; ?>/assets/images/visa.svg" alt="..." class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="<?= $this->baseUrl; ?>/assets/images/mastercard.svg" alt="..." class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="<?= $this->baseUrl; ?>/assets/images/paypal.svg" alt="..." class="payment-icon">
              </li>
            </ul>
          </div>
        </div>
